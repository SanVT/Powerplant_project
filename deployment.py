# -*- coding: utf-8 -*-
"""
Created on Fri Feb 23 11:12:37 2024
...
''')
    ...
    st.write(df)
    dt = pd.read_csv('c:/users/Shitla maa/energy_productioncleaned.csv')
...
if mode == 'About':
    ...
    st.write("* *Santosh Tiwari*")
    st.write("* *Umesh Bandale*")
    st.write("* *Kona harshitreddy*")
    st.write("* *Bhargavi Pulipaka*")
    st.write("* *Sreelaxshmi S*")
    st.write("* *Swapnil Jadhav*")
